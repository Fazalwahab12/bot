    ...
    <>
      <div className="mt-10 mb-10">
        <div className="flex gap-10">
          {/* Left Column */}
          <div className="w-1/2 p-6 bg-white rounded-xl shadow-md space-y-4 border border-[#2563eb]">
            <div>
              ...
              <input
                type="text"
                value={title}
                className="mt-1 block w-full p-2 rounded-md border border-[#2563eb] shadow-sm hover:border-black"
                readOnly
              />
            </div>
          ...
          <div className="w-1/2 p-6 bg-white rounded-xl shadow-md space-y-4 border border-[#2563eb]">
            ...
            <div className="flex items-center gap-3 justify-between">
              <input
                type="number"
                value={usdtAssigned}
                className="mt-1 block w-2/3 p-2 rounded-md border border-[#2563eb] shadow-sm hover:border-black"
                readOnly
              />
              <input
                type="number"
                value={usdtAssigned}
                className="mt-1 block w-2/3 rounded-md p-2 border border-[#2563eb] shadow-sm hover:border-black"
                readOnly
              />
            </div>
            ...
            <div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <input
                  ...
                  className="mt-1 block w-full rounded-md p-2 border border-[#2563eb] shadow-sm hover:border-black"
                  readOnly
                />
              </div>
            </div>
        ...
        <div className="flex mt-10 gap-[120px]">
          <div className="p-4 bg-white rounded-xl shadow-md border border-[#2563eb]">
            ...
            <div className="grid grid-cols-2 gap-4 mb-2">
              ...
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full rounded-md border p-2 border-[#2563eb] shadow-sm hover:border-black"
                  readOnly
                />
              </div>
            </div>
        ...
        <div className="mt-10 p-6 bg-white rounded-xl shadow-md border border-[#2563eb]">
          <h3 className="text-lg font-medium text-gray-700 mb-4">Covers</h3>
          <div className="overflow-x-auto">
            <table className="min-w-full bg-white border rounded-lg border-[#2563eb]">
              <thead>
                  ...
                  <tr key={index} className="border-b">
                    ...
                    <td className="p-2 text-sm text-gray-700">
                      <input
                        ...
                        className="w-full rounded-md  p-2 border border-[#2563eb] shadow-sm hover:border-black"
                        readOnly
                      />
                    </td>
                    <td className="p-2 text-sm text-gray-700">
                    ...
                    <td className="p-2 text-sm text-gray-700">
                      <input
                        type="text"
                        value={cover.type}
                        className="w-full p-2 rounded-md border border-[#2563eb] shadow-sm hover:border-black"
                        readOnly
                      />
                    </td>
                    <td className="p-2 text-sm text-gray-700">

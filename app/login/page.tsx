  ...
  return (
    <div className="flex-flex-col">
      <div className="grid grid-cols-1 lg:grid-cols-2 w-full h-screen">
        <div className="flex flex-col gap-y-8 justify-center items-center md:items-start py-10 md:py-0 px-20 h-full bg-[#2563eb]">
          <div id="logo">
        ...
        <div className="flex flex-col w-full justify-center items-center px-6 md:px-40 bg-[#F2F2F2] bg-no-repeat">
          ...
          >
            ...
            <div className=" bg-blue-600 text-white rounded-full w-full md:w-fit shadow-2xl  hover:to-blue-600 hover:bg-white hover:text-blue-600 py-3 px-10 transition duration-300 transform hover:-translate-y-2">
              SIGN IN
            </div>
          </div>
        </div>
